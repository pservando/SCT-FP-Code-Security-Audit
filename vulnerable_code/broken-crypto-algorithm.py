...
# than 128 bits.
#
# Source: https://github.com/dehvCurtis/vulnerable-code-examples/blob/main/SAST/python/ciphers/pycrypto.py
...
bf2 = Blowfish.new('ChangeItWithYourKey', Blowfish.MODE_CBC, 'ChangeIt') # Noncompliant: Blowfish use a 64-bit block size makes it vulnerable to attacks
